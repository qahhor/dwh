...
## Corpus Check
- 363 files · ~173,639 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3344 nodes · 8372 edges · 174 communities (141 shown, 33 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1160 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9631d45c`
...
- FleetComponent
- errorText
- .shouldHashAndVerifyPasswordCorrectly
...
1. `RequiresPermission` - 119 edges
2. `ErrorCode` - 81 edges
3. `TasksComponent` - 65 edges
4. `AuditLogService` - 50 edges
5. `MsTaskService` - 47 edges
6. `ApiException` - 46 edges
7. `MdUserRepository` - 44 edges
8. `UsersComponent` - 42 edges
9. `ToastService` - 40 edges
10. `MdPermissionService` - 39 edges
...
Cohesion: 0.08
Nodes (16): FlywayControlPlaneScriptIntegrityTest, ModularArchitectureTest, AuditLogServiceTest, GlobalExceptionHandlerTest, TraceparentFilterTest, FlywayMigrationScriptIntegrityTest, FlywayMigrationValidationTest, KauthPasswordHasherTest (+8 more)

### Community 1 - "ToastService"
Cohesion: 0.06
Nodes (44): routes, authGuard(), FieldErrorItem, KeysetPage, ProblemDetail, ApiService, Injectable, AuthService (+36 more)

### Community 2 - "MfFileRepository"
Cohesion: 0.07
Nodes (16): MfPref, FileDetailRecord, FileRecord, ResultSet, MfFileRepository, MfFileService, StorageStats, Override (+8 more)
...
Cohesion: 0.18
Nodes (8): ResultSet, SuppressWarnings, MdUserRepository, MdCustomFieldService, MdUserService, PasswordValidator, UserSessionInvalidator, MdUserServiceTest
...
Cohesion: 0.04
Nodes (51): ErrorCode, BAD_REQUEST, CODE_ALREADY_EXISTS, CONFLICT, CSRF_TOKEN_INVALID, EMPTY_QUERY, FIELD_IN_USE, FILE_CORRUPTED (+43 more)
...
Cohesion: 0.11
Nodes (25): CpBootstrap, CpMigrateModeRunner, Override, AuditPartitionWorker, CpHeartbeatWorker, Override, MigrateModeRunner, KauthSessionCleanupWorker (+17 more)
...
Cohesion: 0.08
Nodes (15): ApiTokenRecord, KauthApiTokenRepository, KauthSessionRepository, KauthAuthenticationFilter, CreatedTokenResult, KauthApiTokenService, KauthSessionService, Override (+7 more)

### Community 20 - "CpSecurityConfig.java"
Cohesion: 0.13
Nodes (20): CpSecurityConfig, FilterRegistrationBean, Override, CpAuthFilter, CpRoleInterceptor, FilterRegistrationBean, SecurityConfig, Override (+12 more)

### Community 21 - ".getCurrentUserId"
Cohesion: 0.07
Nodes (26): CreateTokenDto, DeleteMapping, GetMapping, PostMapping, RequestMapping, RestController, KauthApiTokenController, GetMapping (+18 more)
...
Cohesion: 0.09
Nodes (10): RequestMapping, RestController, MsAnnouncementController, MsNotifyPref, AnnouncementRecord, MsAnnouncementRepository, MsNotificationRepository, NotificationRecord (+2 more)
...
### Community 26 - "jakarta.servlet.http.HttpServletRequest"
Cohesion: 0.24
...
### Community 27 - "AuditLogService"
Cohesion: 0.08
Nodes (18): AuditLogService, CreateRoleDto, PatchMapping, PostMapping, RequestMapping, RestController, MdRoleController, UpdateRoleDto (+10 more)

### Community 28 - "KauthAuthService"
Cohesion: 0.10
Nodes (7): GetMapping, KauthLoginAttemptRepository, KauthOtpCodeRepository, OtpRecord, SessionRecord, KauthAuthService, LoginResult
...
Cohesion: 0.07
Nodes (13): Announcement, Content, ContentDto, CpAnnouncementRepository, CpTelemetryRepository, IdempotencyRepository, IdempotencyService, ChannelRecord (+5 more)
...
Cohesion: 0.09
Nodes (13): GetMapping, TaskDetailResponse, TaskMemberRecord, ResultSet, SuppressWarnings, MsTaskRepository, ProjectTaskStats, TaskCreateData (+5 more)
...
Cohesion: 0.15
Nodes (4): ApiException, MdPref, MdUserView, org.springframework.stereotype.Service
...
### Community 39 - "jakarta.servlet.http.HttpServletResponse"
Cohesion: 0.18
Nodes (8): IdempotencyFilter, Override, Override, TraceparentFilter, KauthPref, jakarta.servlet.FilterChain, jakarta.servlet.http.HttpServletResponse, org.springframework.web.filter.OncePerRequestFilter

### Community 40 - "MdScopeServiceIntegrationTest"
Cohesion: 0.11
Nodes (3): ScopeFilter, MdScopeRepository, MdScopeServiceIntegrationTest
...
### Community 46 - "SchemaVersionGate"
Cohesion: 0.36
Nodes (4): CpSchemaVersionGate, SchemaVersionGate, jakarta.annotation.PostConstruct, javax.sql.DataSource

### Community 47 - "KauthAuthController"
Cohesion: 0.23
...
Cohesion: 0.09
Nodes (16): ProjectMember, ProjectTaskStats, TaskComment, TaskDetailResponse, TaskFile, TaskMember, TaskStatus, TaskType (+8 more)
...
### Community 52 - "tools.jackson.databind.ObjectMapper"
Cohesion: 0.15
Nodes (10): CpAuthEntryPoint, Override, Logger, Override, ProblemDetailAuthHandlers, org.springframework.security.access.AccessDeniedException, org.springframework.security.core.AuthenticationException, org.springframework.security.web.access.AccessDeniedHandler (+2 more)
...
Cohesion: 0.06
Nodes (17): CreateSubscriptionDto, GetMapping, PatchMapping, RequestMapping, RestController, KwhSubscriptionController, UpdateSubscriptionDto, KwhPref (+9 more)

### Community 57 - "org.springframework.http.ResponseEntity"
Cohesion: 0.07
Nodes (30): RequiresPermission, DeleteMapping, PostMapping, AssignRolesDto, GrantDto, MdAssignmentController, ReplacePermissionsDto, DeleteMapping (+22 more)
...
Cohesion: 0.15
Nodes (10): InstanceBootstrap, Override, InstanceBootstrapProperties, KauthPasswordHasher, PasswordHasher, MigrationGateAndBootstrapTest, de.mkammerer.argon2.Argon2, MethodOrderer.OrderAnnotation (+2 more)

### Community 63 - "MfFileController"
Cohesion: 0.18
Nodes (8): DeleteMapping, GetMapping, PostMapping, RequestMapping, RestController, StorageStats, MfFileController, InputStreamResource

### Community 64 - "GlobalExceptionHandler.java"
Cohesion: 0.19
Nodes (13): GlobalExceptionHandler, com.fasterxml.jackson.annotation.JsonInclude, ProblemDetailRecord, MethodArgumentTypeMismatchException, MissingServletRequestParameterException, org.springframework.dao.DataIntegrityViolationException, org.springframework.http.converter.HttpMessageNotReadableException, org.springframework.web.bind.annotation.ExceptionHandler (+5 more)
...
Cohesion: 0.13
Nodes (4): MsTaskPref, CursorUtils, KeysetPage, CursorUtilsTest

### Community 73 - "MsTaskTypeRepository"
Cohesion: 0.15
Nodes (3): MsTaskMemberRepository, MsTaskTypeRepository, TypeRecord
...
Cohesion: 0.09
Nodes (13): Override, CpAuthController, LoginDto, CpSession, CpSessionRepository, CpUser, CpUserRepository, ResultSet (+5 more)
...
### Community 77 - "MsOutboxWorker.java"
Cohesion: 0.16
Nodes (5): ConsoleMessengerProvider, Override, Override, MessengerMessage, MessengerSendResult
...
### Community 83 - "CustomFieldsComponent"
Cohesion: 0.14
...
Cohesion: 0.09
Nodes (18): CpPref, AuditLogController, AuditRecord, AuditStats, SecurityEventRecord, AuditPref, OpenApiController, MdI18nController (+10 more)

### Community 100 - "org.springframework.transaction.annotation.Transactional"
Cohesion: 0.20
Nodes (3): ProjectTaskStats, MsTaskService, org.springframework.transaction.annotation.Transactional
...
### Community 106 - "MsTaskController"
Cohesion: 0.14
Nodes (13): AttachFileDto, ChangeStatusDto, CreateStatusDto, CreateTaskDto, CreateTypeDto, PatchMapping, PostMapping, RequestMapping (+5 more)

### Community 107 - "CpRequiresRole"
Cohesion: 0.25
...
### Community 110 - "SecurityContext"
Cohesion: 0.10
Nodes (7): KauthPrincipal, SecurityContext, KauthPrincipal, Override, KauthPrincipal, KauthSecurityContext, Override
...
Cohesion: 0.09
Nodes (14): CpClientProperties, DwhInfoContributor, Override, RateLimitProperties, TypesenseProperties, CpHeartbeatWorkerTest, BuildProperties, Builder (+6 more)
...
- **What is the exact relationship between `Typesense Search Env Config (no typesense service declared)` and `M17. Full-Text Search (SEARCH)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `RequiresPermission` connect `org.springframework.http.ResponseEntity` to `org.junit.jupiter.api.Test`, `MfFileRepository`, `.getCurrentUserId`, `MdCustomFieldRepository`, `MsNotificationService`, `MsProjectRepository`, `AuditLogService`, `KauthAuthService`, `KauthSessionController`, `MsTaskRepository`, `ApiException`, `jakarta.servlet.http.HttpServletResponse`, `KwhOutboxRepository`, `MfFileController`, `.createTask`, `MsTaskService.java`, `MsTaskTypeRepository`, `MsTaskCommentRepository`, `org.springframework.web.bind.annotation.GetMapping`, `org.springframework.transaction.annotation.Transactional`, `MsTaskController`, `CpRequiresRole`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `ErrorCode` connect `ErrorCode` to `GlobalExceptionHandler.java`, `MfFileRepository`, `org.springframework.transaction.annotation.Transactional`, `ApiException`, `jakarta.servlet.http.HttpServletResponse`, `AuditLogService`, `FieldErrorItem`, `MsTaskService.java`, `.badRequest`, `tools.jackson.databind.ObjectMapper`, `MdScopeService`, `KauthAuthService`?**
