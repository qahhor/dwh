...
## Corpus Check
- 435 files · ~205,871 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3769 nodes · 9527 edges · 211 communities (169 shown, 42 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 1265 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ae33d634`
...
## Communities (211 total, 42 thin omitted)

### Community 0 - "org.junit.jupiter.api.Test"
Cohesion: 0.06
Nodes (19): FlywayControlPlaneScriptIntegrityTest, CpClientProperties, ModularArchitectureTest, AuditLogServiceTest, CpHeartbeatWorkerTest, BuildProperties, GlobalExceptionHandlerTest, IdempotencyServiceTest (+11 more)
...
Cohesion: 0.12
Nodes (5): AuditLogService, SecurityEventRecord, MdSettingRepository, MdSettingService, org.springframework.stereotype.Service
...
Cohesion: 0.12
Nodes (24): CpBootstrap, CpMigrateModeRunner, Override, CpSchemaVersionGate, Override, MigrateModeRunner, SchemaVersionGate, KauthSessionCleanupWorker (+16 more)
...
Cohesion: 0.07
Nodes (24): DeleteMapping, GetMapping, PostMapping, GetMapping, MeResponse, PostMapping, CreateUserDto, DeleteMapping (+16 more)
...
### Community 25 - "MdScopeServiceIntegrationTest"
Cohesion: 0.12
Nodes (4): ScopeFilter, MdScopeRepository, UserScope, MdScopeServiceIntegrationTest
...
Cohesion: 0.08
Nodes (26): RequiresPermission, DeleteMapping, AssignRolesDto, GrantDto, MdAssignmentController, ReplacePermissionsDto, DeleteMapping, AssignUnitsDto (+18 more)

### Community 28 - "KauthOtpLoginIntegrationTest"
Cohesion: 0.11
Nodes (5): ChannelRecord, KauthLoginAttemptRepository, OtpRecord, KauthOtpLoginIntegrationTest, java.util.regex.Pattern
...
Cohesion: 0.16
Nodes (11): SessionRecord, KauthPrincipal, Override, KauthAuthenticationFilter, MdPermissionService, RateLimitFilterTest, SecurityConfigTest, org.springframework.boot.webmvc.test.autoconfigure.WebMvcTest (+3 more)

### Community 34 - "MsTaskService"
Cohesion: 0.07
Nodes (19): GetMapping, ProjectTaskStats, TaskDetailResponse, UpdateTaskDto, TaskAssigned, MsTaskMemberRepository, TaskMemberRecord, ResultSet (+11 more)
...
### Community 38 - "MdRoleRepository"
Cohesion: 0.10
Nodes (10): CreateRoleDto, PatchMapping, PostMapping, RequestMapping, RestController, MdRoleController, UpdateRoleDto, MdRoleRepository (+2 more)

### Community 39 - "KauthOtpLoginIntegrationTest.java"
Cohesion: 0.14
Nodes (9): KauthChannelRepository, KauthOtpCodeRepository, KauthPasswordResetRepository, ResetRecord, KauthAuthService, KauthChannelService, KauthOtpSender, PasswordValidator (+1 more)
...
Cohesion: 0.13
Nodes (13): AttachFileDto, ChangeStatusDto, CreateStatusDto, CreateTaskDto, CreateTypeDto, DeleteMapping, PatchMapping, PostMapping (+5 more)
...
Cohesion: 0.08
Nodes (16): CreateSubscriptionDto, GetMapping, PatchMapping, RequestMapping, RestController, KwhSubscriptionController, UpdateSubscriptionDto, ResultSet (+8 more)

### Community 57 - "MdPermissionRepository"
Cohesion: 0.12
...
Cohesion: 0.18
Nodes (6): AuditLogRepository, AuditRecord, ResultSet, SuppressWarnings, SecurityEventRecord, AuditRecord
...
Cohesion: 0.10
Nodes (12): InstanceBootstrap, Override, InstanceBootstrapProperties, Override, KauthPasswordHasher, PasswordHasher, MigrationGateAndBootstrapTest, KauthPasswordHasherTest (+4 more)
...
Cohesion: 0.14
Nodes (17): GlobalExceptionHandler, com.fasterxml.jackson.annotation.JsonInclude, jakarta.servlet.http.HttpServletRequest, FieldErrorItem, ProblemDetailRecord, MethodArgumentTypeMismatchException, MissingServletRequestParameterException, org.springframework.dao.DataIntegrityViolationException (+9 more)
...
### Community 71 - "ProviderRegistry"
Cohesion: 0.14
Nodes (6): NotificationChannelStartupCheck, ProviderRegistry, MsOutboxWorker, MailProvider, MessengerProvider, SmsProvider

### Community 72 - "TypesenseClient"
Cohesion: 0.09
Nodes (15): DwhInfoContributor, Override, SearchHit, SearchResult, SearchService, SearchHit, TypesenseClient, TypesenseIndexer (+7 more)

### Community 73 - "jakarta.servlet.http.HttpServletResponse"
Cohesion: 0.19
Nodes (11): CpAuthEntryPoint, Override, Logger, Override, ProblemDetailAuthHandlers, ProblemDetailAuthHandlersTest, jakarta.servlet.http.HttpServletResponse, org.springframework.security.access.AccessDeniedException (+3 more)
...
Cohesion: 0.09
Nodes (16): Override, CpAuthController, LoginDto, CpPref, CpSession, CpSessionRepository, CpUser, CpUserRepository (+8 more)
...
### Community 80 - "ApiException"
Cohesion: 0.10
Nodes (10): ApiException, KauthPrincipal, SecurityContext, KwhPref, MdPref, MdUserService, MsNotifyPref, MsTaskPref (+2 more)
...
### Community 85 - "org.springframework.transaction.annotation.Transactional"
Cohesion: 0.11
Nodes (4): PermissionPair, DeleteMapping, MsProjectService, org.springframework.transaction.annotation.Transactional
...
### Community 98 - "ProviderHealth"
Cohesion: 0.11
Nodes (12): ConsoleMailProvider, Override, ConsoleSmsProvider, Override, Override, SmtpMailProvider, Override, StubRealMailProvider (+4 more)

### Community 99 - "org.springframework.web.bind.annotation.GetMapping"
Cohesion: 0.09
Nodes (17): AuditLogController, AuditRecord, AuditStats, SecurityEventRecord, AuditPref, OpenApiController, MdI18nController, MsSseController (+9 more)
...
Cohesion: 0.09
Nodes (12): CreateTokenDto, RequestMapping, RestController, KauthApiTokenController, ApiTokenRecord, KauthApiTokenRepository, KauthSessionRepository, CreatedTokenResult (+4 more)
...
### Community 120 - "KauthOtpSender.java"
Cohesion: 0.20
...
### Community 161 - "org.springframework.scheduling.annotation.Scheduled"
Cohesion: 0.16
...
### Community 164 - "KauthSessionService"
Cohesion: 0.14
...
Cohesion: 0.19
Nodes (5): Override, DeleteMapping, HandlerMethod, RequiresPermissionInterceptorTest, SecuredController
...
### Community 196 - "MsProjectController"
Cohesion: 0.21
...
### Community 198 - "UiModalComponent"
Cohesion: 0.22
Nodes (5): Component, HostListener, Input, Output, UiModalComponent

### Community 205 - "UiPaginationComponent"
Cohesion: 0.27
Nodes (4): Component, Input, Output, UiPaginationComponent

### Community 207 - "TraceparentFilter"
Cohesion: 0.39
Nodes (3): Override, TraceparentFilter, jakarta.servlet.FilterChain
...
- **What is the exact relationship between `Typesense Search Env Config (no typesense service declared)` and `M17. Full-Text Search (SEARCH)`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `ErrorCode` connect `ErrorCode` to `jakarta.servlet.http.HttpServletRequest`, `MfFileRepository`, `KwhOutboxRepository`, `AuditLogService`, `KauthOtpLoginIntegrationTest.java`, `TypesenseClient`, `jakarta.servlet.http.HttpServletResponse`, `ApiException`, `MsTaskService.java`, `org.springframework.transaction.annotation.Transactional`, `KauthOtpSender.java`, `RateLimitFilter`, `KauthOtpLoginIntegrationTest`, `IdempotencyService`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `RequiresPermission` connect `org.springframework.http.ResponseEntity` to `org.springframework.stereotype.Component`, `MsTaskCommentService`, `.getCurrentUserId`, `MdCustomFieldService`, `CpFleetRepository`, `MsTaskService`, `KauthSessionService`, `MdRoleRepository`, `KauthChannelController`, `MdScopeServiceIntegrationTest.java`, `MsTaskController`, `KwhOutboxRepository`, `.preHandle`, `MsProjectController`, `MdFormCatalogTest.java`, `ApiException`, `org.springframework.transaction.annotation.Transactional`, `org.springframework.web.bind.annotation.GetMapping`, `MsProjectRepository`, `MsTaskTypeRepository`, `MfFileController.java`?**
