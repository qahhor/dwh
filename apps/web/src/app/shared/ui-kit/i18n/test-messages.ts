...
export const TEST_MESSAGES: SMTMessages = {
  ...
  button: { busy: 'In progress' },
  rating: { name: 'Rating', star: (star, max) => `${star} of ${max}` },
  range: { from: 'From', to: 'To' },
  weekday: { name: 'Days of the week' },
  cropper: {
    area: 'Crop area',
    help: 'Drag the frame or move it with the arrow keys; Shift with the arrows resizes it',
    status: (x, y, width, height) => `${width} by ${height} from ${x}, ${y}`,
  },
  ...
  sortable: {
    ...
    moved: (label, position, total) => `${label}: place ${position} of ${total}`,
  },
  file: {
    ...
    previous: 'Previous',
    next: 'Next',
    cannotShow: 'This image cannot be shown.',
    downloadInstead: 'Download it',
  },
