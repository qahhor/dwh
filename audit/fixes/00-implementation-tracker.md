...
Source of truth:
`audit/00-master-improvement-plan-2026-09-02.md`. Статус обновлён 2026-09-02 для
...
|---|---|---|---|---|---|---|
| P0-01/P0-08 | [T-01 release gates](T-01-release-gates.md) | P0 | M | TBD | In review | Pushed SHA `5013ebd`: backend 194/194, frontend 68/68, typecheck/build, Compose/docs/actionlint и clean E2E 9/9 green; remote run отсутствует до PR |
