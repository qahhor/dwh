...
Source of truth: `audit/00-master-improvement-plan-2026-08-31.md`. Статус обновлён 2026-09-01 после локальной реализации и clean-slate verification. `Verified` по-прежнему разрешён только для immutable RC с зелёным remote CI; поэтому реализованные локально пункты остаются `In review`. Evidence первого Fleet Foundation slice: [`fleet-foundation-cp-contract-2026-09-01.md`](../evidence/fleet-foundation-cp-contract-2026-09-01.md).

| ID | Карточка | Priority | Effort | Owner | Status | Текущее evidence / остаток |
|---|---|---|---|---|---|---|
| P0-01/P0-08 | [T-01 release gates](T-01-release-gates.md) | P0 | M | TBD | In review | Локально: backend 288/288, frontend 63/63, build/typecheck, E2E 8/8; нужен pushed SHA и remote required checks |
...
| CP-FF-01 | [Fleet Foundation contract evidence](../evidence/fleet-foundation-cp-contract-2026-09-01.md) | P0 | L | TBD | In review | Локально PASS: V006 upgrade/clean migration, instance credential boundary, typed/bounded heartbeat, backup ownership, immutable release, principal-bound desired state и deployment history; remote CI и runtime rollout/supply-chain adapters остаются открыты |
