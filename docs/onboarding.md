...
6. [CONTRIBUTING](../CONTRIBUTING.md) — DoR/DoD, ветки, ревью. Главные три правила:
   - задача без **точного результата** не берётся в работу;
   - расхождение реализации со сценарием ТЗ-03 — дефект, а не интерпретация;
   - **до явной команды CEO код не пишется** — сейчас фаза документов.
