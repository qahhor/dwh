...
|---|---|---|---|
| R1 | **Версии:** Spring Boot 3.4.3 → 4.1.x; Java 23 → 25 LTS; PostgreSQL 16 → 18 (+pgvector в образе); Angular — без изменений (22 ✓) | D-1, D-10 | `mvn verify` зелёный на новых версиях; ни одной зависимости вне поддержки |
