...
Дата: 2026-09-07.
Статус: детальный дизайн подтверждён пользователем 2026-09-07.
Основание: запрос изучить поиск/Typesense, «Давай все подрят» и последующее «подтверждаю».
Это согласованный проект реализации; каноническое ТЗ и действующие ADR сохраняют свою роль.
