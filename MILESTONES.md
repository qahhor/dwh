...
### M3. Авторизация и аутентификация (AUTH) [◐ ЧАСТИЧНО] код 2026-08-29 · 30.08 закрыт Д-7: смена своего пароля выведена в контур аутентификации · восстановление пароля и OTP работают только на настроенном SMTP или Telegram, боевой SMS-шлюз ждёт договор
